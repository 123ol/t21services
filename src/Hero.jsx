  ...
  const [faqs, setfaqs] = useState([
    {
      ...
      answer:
        "Through T21, individuals are trained and/or connected to their dream jobs, while helping companies and organizations achieve their business improvements and competitive strength.",
      open: true,
    },
    {
      question: "HOW DO WE GROW YOUR BUSINESS?",
      answer:
        "We Create your consumer-focused system or app with us, from conception and design through delivery, for the seamless functioning of your brand.",
      open: false,
    },
    {
      question: "HOW DO WE HELP YOU BUILD YOUR CAREER?",
      answer:
        "Whichever time you choose, our parts of making sure the best resources are available for you are 100% covered.",
      open: false,
    },
    {
      question: "HOW DO WE ENSURE YOUR SUCCESS?",
      answer:
        "Our recruitment patterns and other modes of operations are crafted in a way that you’ll easily get results; only your consent is needed to complete the Success Cycle for you.",
      open: false,
    },
    {
      question: "HOW DO WE HELP YOU FIND YOUR DREAM JOB?",
      answer:
        "Browse our catalogue, with numerous and custom jobs that best suit your field akin, to our offerings.",
      open: false,
    },
    {
      question: "WHO ARE WE?",
  ...
  return (
    <div>
        ...
        <div className="flex flex-col md:flex-row mt-[5rem] justify-between items-center max-w-6xl gap-0 lg:gap-24 w-full px-6 py-10">
          ...
          <div className="relative md:w-1/2 mt-0 md:mt-0 h-fit">
            <div
              ...
              style={{
                background:
                  "linear-gradient(232.28deg, #DD9933 28.19%, #191919 100.01%)",
              }}
            >
            ...
            <div className="relative ml-10">
              <img src={img} alt="Result Oriented" className="" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="faqs genbg">
        <p className="lg:text-5xl p-2  text-4xl text-center font-extrabold bg-gradient-to-r from-[#DD9933] to-[#191919] text-transparent bg-clip-text">
          Frequently Asked Questions
        </p>
        <h2 className="text-2xl lg:text-2xl font-bold text-[#191919] text-center">
          Quick Answers to questions you may have about T21 Services
        </h2>
        {faqs.map((faq, i) => (
      ...
      <div className=" py-10 lg:py-20 px-4 lg:px-10  genbg " id="Contact">
        <h2 className="text-3xl lg:text-4xl font-bold text-[#191919] mb-4">
          Contact Us
        </h2>
        <p className="lg:text-[65px] mb-8 text-[65px] font-extrabold bg-gradient-to-r from-[#DD9933] to-[#191919] text-transparent bg-clip-text">
          Contact us at your finger tip.
        </p>
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center lg:space-x-8 ">
          ...
          <div className="w-full lg:w-1/2 bg-white shadow-2xl rounded-[50px] p-8 lg:p-[3rem]">
            <form className="space-y-4">
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <div className="w-full sm:w-1/2">
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full p-3 border border-[#DD9933] rounded-lg mt-1 focus:ring-2 focus:ring-yellow-500"
                    placeholder="John"
                    required
                  />
                </div>
              ...
              <button
                type="submit"
                className="w-[150px] bg-[#DD9933] hover:bg-yellow-600 text-white font-semibold p-3 rounded-lg"
              >
                Submit
              </button>
            </form>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-cover bg-center bg-no-repeat flex flex-col items-center text-center  w-full shadow-lg rounded-[50px] pb-4">
                ...
                <div className="px-[1rem] max-w-[200px]">
                  <p className="font-semibold text-[#DD9933]">
                    Our Mail Address
                  </p>
              ...
              <div className="bg-cover bg-center bg-no-repeat flex flex-col items-center text-center  w-full shadow-lg rounded-[50px] pb-4">
                ...
                <div className="px-[1rem] max-w-[250px]">
                  ...
                  <div className="py-[0.5rem] rounded-3xl border border-[#DD9933]">
                    <p
                      className="text-gray-600 text-left border-b-2 px-4 border-[#DD9933]
    "
                    >
                      <span className="font-bold text-[#DD9933]">
                        Head office
                      </span>
                      <br />
                      Old St Lawrence School, Westminster Road, Liverpool.L4
                      3TQ.
                    </p>
                    <p className="text-left text-gray-600 px-4 mt-2">
                      {" "}
                      <span className="font-bold text-[#DD9933]">
                        ADO OFFICE
                      </span>{" "}
                      <br />
                      No 68, Lino building opposite Crunchies eatery, Eksuth
                      Area Similoluwa, Ado-Ekiti
                    </p>
                    <p className="text-left text-gray-600 px-4 mt-2 border-t border-[#DD9933]">
                      {" "}
                      <span className="font-bold text-[#DD9933]">
                        LAGOS OFFICE
                      </span>{" "}
                      <br />
                      ICAN Building 5th floor, Yaba Lagos, Lagos State
                    </p>
                  </div>
                </div>
              </div>
              <div className="bg-cover bg-center bg-no-repeat flex flex-col items-center text-center  w-full shadow-lg rounded-[50px] pb-4 h-fit">
                ...
                <div className=" max-w-[200px] ">
                  <p className="font-semibold mb-2 text-[#DD9933]">
                    Call Us for Help!
                  </p>
                  <div className="py-[0.5rem] rounded-3xl border border-[#DD9933]">
